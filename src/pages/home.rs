      ...
      <>
        <div>
          <div class="timeheader">
            {"Mon Apr 17 6:19PM San Francisco - The Time is Now"}
          </div>
          <h3>
  ...
  fn apr14(&self, ctx: &Context<Self>) -> Html {
    html!{
      <>
        <div>
          <div class="timeheader">
            {"Fri Apr 14 8:59PM San Francisco - The Time is Now"}
          </div>
          <h3>
  ...
  fn apr13(&self, ctx: &Context<Self>) -> Html {
    html!{
      <>
        <div>
          <div class="timeheader">
            {"Thurs Apr 13 10:22PM San Francisco - The Time is Now"}
          </div>
          <h3>
  ...
  fn apr12(&self, ctx: &Context<Self>) -> Html {
    html!{
      <>
        <div>
          <div class="timeheader">
            {"Wed Apr 12 8:40PM San Francisco - The Time is Now"}
          </div>
          <h3>
